...
void introScreen()
{
 glClear(GL_COLOR_BUFFER_BIT);
  ...
  glColor3f(1.0, 0.0, 0.0);
 displayRasterText(-425, 490, 0.0,"CAMBRIDGE INSTITUTE OF TECHNOLOGY");
 ...
 displayRasterText(-225, 200, 0.0,"Spaceship Shooting Game");
   glColor3f(1.0, 0.0, 0.0);
   displayRasterText(-200, -100, 0.0," STUDENT NAMES");
    glColor3f(1.0, 1.0, 1.0);
 displayRasterText(-180, -200, 0.0,"Aishwarya Polineni");
 displayRasterText(-180, -285, 0.0,"Vishwa Patel");
  glColor3f(1.0, 0.0, 0.0);
